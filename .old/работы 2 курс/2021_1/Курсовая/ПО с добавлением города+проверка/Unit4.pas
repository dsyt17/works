...
begin
              ...
              begin showmessage('Введите название города!');  exit;
              end;
              if combobox1.Text='Выберите страну' then
              begin showmessage('Выберите страну!');  exit;
              end;
              if combobox2.Text='Выберите размер' then
              begin showmessage('Выберите размер города!');  exit;
              end;
              if not CheckPresent(CheckListBox1) then
              begin ShowMessage('Выберите инфраструктуру!'); exit;
              end;
              {if memo1.Text='' then
              begin showmessage('Заполните описание города!');  exit;
              end; }
